...
const Storageaccessoriesupdate = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch(`https://api.homeessentialshive.co.uk/api/v1/auth/storageaccesssingle/${params.id}`);
    ...
    const updateUser = async (e) => {
        ...
        try {
            let response = await fetch(`https://api.homeessentialshive.co.uk/api/v1/auth/storageaccesssingle/${params.id}`, {
                method: "PUT",
                body: formData
            });
