...
const Akonobolist = () => {
    ...
    const setUsersData = async() =>{
        let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/data/Akonoboluser")
      ...
      const deleteuser = async(id)=>{
          // console.log(id)
          try {
              let result= await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/Akonoboluserid/${id}`,{
            method:"delete"
