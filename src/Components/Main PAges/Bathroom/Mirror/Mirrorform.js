...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/mirrorproducts" , {
//         method: "post",
//         body :formdata
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth/mirrorproducts', {
                method: 'POST',
                body: formData
            });
