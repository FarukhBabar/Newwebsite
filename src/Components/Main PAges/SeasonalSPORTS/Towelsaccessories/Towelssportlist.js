...
const Towelssportlist = () => {
    ...
    const setUsersData = async() =>{
        let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/data/umbrellauser")
      ...
      const deleteuser = async(id)=>{
          // console.log(id)
          try {
              let result= await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/umbrellauserid/${id}`,{
            method:"delete"
