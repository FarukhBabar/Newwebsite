...
const Picniclist = () => {
    ...
    const setUsersData = async() =>{
        let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/data/picnicuser")
      ...
      const deleteuser = async(id)=>{
          // console.log(id)
          try {
              let result= await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/picnicuserid/${id}`,{
            method:"delete"
