...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/wernerproducts" , {
//         method: "post",
//         body :formdata
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth/wernerproducts', {
                method: 'POST',
                body: formData
            });
